...
| Supermercado / Minimarket | Subprograma persistente avanzado | Caja POS transaccional, catálogo e imágenes, EAN, promociones, precios masivos, stock, compras, recepción, lotes FEFO, devoluciones, conteos, mermas, transferencias, mapa de góndolas, etiquetas auditables, fidelización y rentabilidad con costos históricos por producto, categoría y sucursal. | Agregar conciliación de proveedores y pronóstico de demanda. |
...
| Supermercado | Conciliación de proveedores, rotación y pronóstico de demanda. |
