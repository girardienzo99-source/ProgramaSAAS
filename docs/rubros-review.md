...
| Supermercado / Minimarket | Subprograma persistente avanzado | Caja POS transaccional, catálogo e imágenes, EAN, promociones, precios masivos, stock, compras, recepción, lotes FEFO, devoluciones, conteos, mermas y transferencias entre sucursales. | Agregar góndolas, etiquetas, fidelización y reportes consolidados. |
