...
| Supermercado / Minimarket | Subprograma persistente avanzado | Caja POS transaccional, catálogo, promociones, stock, compras, lotes FEFO, controles, góndolas, etiquetas, fidelización, rentabilidad, proveedores, cuenta corriente, conciliación, pronóstico, aprobaciones multinivel, portal externo, ASN, remitos PDF privados, recepciones parciales, reclamos automáticos auditables, mensajes EDI DESADV/RECADV/COMDIS en outbox, consola EDI operativa, estados de reintento, dead-letter y alertas por mensajes fallidos. | Conectar el worker EDI a redes externas reales, credenciales por proveedor y acuse automático del receptor. |
...
| Supermercado | Worker EDI externo, credenciales por proveedor, acuses del receptor y conciliación automática de errores. |
