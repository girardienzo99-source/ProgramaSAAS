...
| Supermercado / Minimarket | Subprograma persistente avanzado | Caja POS transaccional, catálogo e imágenes, EAN, promociones, precios masivos, stock, compras, recepción, lotes FEFO, devoluciones, conteos, mermas, transferencias, mapa de góndolas y etiquetas auditables. | Agregar fidelización y reportes consolidados. |
...
| Supermercado | Fidelización, campañas, rentabilidad por categoría y reportes consolidados de sucursales. |
