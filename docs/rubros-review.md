...
| Supermercado / Minimarket | Segunda mejora funcional | Espacio propio con caja POS conectada, catálogo editable, imágenes, EAN, promociones, precios, stock, compra sugerida, órdenes a proveedores, recepción, lotes, vencimientos y consumo FEFO. | Persistir catálogo, imágenes, ventas, compras y lotes en backend; agregar transferencias entre depósitos y conteos cíclicos. |
...
| Supermercado | Transferencias, conteos cíclicos, góndolas, etiquetas, mermas, precios masivos y conciliación de cajas. |
